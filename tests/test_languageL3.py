...
def test_languageL3():
    ...
    assert languageL3.get_is_accepted("01") == False
    ...
    assert languageL3.get_is_accepted("001") == False
    assert languageL3.get_is_accepted("010") == False
    ...
    assert languageL3.get_is_accepted("0001") == False
    assert languageL3.get_is_accepted("0010") == False
    assert languageL3.get_is_accepted("0011") == True
    assert languageL3.get_is_accepted("0100") == False
    assert languageL3.get_is_accepted("0101") == False
    assert languageL3.get_is_accepted("0110") == False
    assert languageL3.get_is_accepted("0111") == False
